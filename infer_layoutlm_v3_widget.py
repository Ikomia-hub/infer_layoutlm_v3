...
from infer_layoutlm_v3.infer_layoutlm_v3_process import InferLayoutlmV3Param
from torch.cuda import is_available
import os
from infer_layoutlm_v3.utils import Autocomplete
# PyQt GUI framework
...
# --------------------
class InferLayoutlmV3Widget(core.CWorkflowTaskWidget):

    def __init__(self, param, parent):
        core.CWorkflowTaskWidget.__init__(self, parent)

        if param is None:
            self.parameters = InferLayoutlmV3Param()
        else:
        ...
        urlLink = "<a href=\"https://huggingface.co/models?sort=downloads&search=layoutlmv3\">"\
...
# --------------------
class InferLayoutlmV3WidgetFactory(dataprocess.CWidgetFactory):

    def __init__(self):
        dataprocess.CWidgetFactory.__init__(self)
        # Set the name of the process -> it must be the same as the one declared in the process factory class
        self.name = "infer_layoutlm_v3"

    def create(self, param):
        # Create widget object
        return InferLayoutlmV3Widget(param, None)
